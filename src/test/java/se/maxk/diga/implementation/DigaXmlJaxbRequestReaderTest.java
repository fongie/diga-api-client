...
class DigaXmlJaxbRequestReaderTest {
  ...
  private static final String sampleBillingValidationReport =
  ...
  @Test
  void testReadBillingReportCompletesWithoutErrors()
      throws JAXBException, IOException, DigaXmlReaderException {
    var response =
        reader.readBillingReport(
            new ByteArrayInputStream(
                sampleBillingValidationReport.getBytes(StandardCharsets.UTF_8)));
    Assertions.assertNotNull(response);
  }

  @Test
  void testReadCodeValidationResponseCompletesWithoutErrors()
      throws JAXBException, IOException, DigaXmlReaderException {
    var response =
