...
public final class DigaUtils {
  ...
  /**
   * Given an endpoint as contanied in the health insurance company mapping file (f.e
   * diga.bitmarck-daten.de), return the full https endpoint to POST codes to (f.e
   * https://diga.bitmarck-daten.de/diga)
   *
   * @param endpoint
   * @return
   */
